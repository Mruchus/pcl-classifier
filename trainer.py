...
if __name__ == "__main__":
    ...
    # only keep columns needed for training (drop og text and metadata)
    ...
    # compute weights for each class for weighted loss
    # class counts from training set: [7581 negatives, 794 positives]?
    # inverse‑frequency weights: [0.0001, 0.0013] -> positive weight ~10× larger
    # force loss to penalise positive mistakes more heavily, handling imbalance
    ...
    # retrain best param combination
